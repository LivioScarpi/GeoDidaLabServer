                      ...
                      <div class="row mt-2">
                        <div class="col-12">
                          ...
                          <div class="mt-4">
                            ...
                            <visita
                              class="align-top text-center"
                              :item="activityVisitPOISelectedForInfo"
                      ...
                      >
                        ...
                        >
                          <div class="px-3">
                            ...
                            <div
                              class="row text-justify fadeeffect"
  ...
  methods: {
    ...
    getDescriptionAndMediaOfPOI() {
      ...
      Array.prototype.forEach.call(
        store.state.sottoitinerari,
        (sottoitinerario) => {
          Array.prototype.forEach.call(sottoitinerario.poi, (poi) => {
            var filteredPOI = store.state.POIpivot.filter(
              (p) => p["geo:Titolo_it"][0]["@value"] === poi.poiName
            );
            ...
            if (filteredPOI.length > 0) {
              poi.poiDescription =
                filteredPOI[0]["dcterms:description"][0]["@value"];
    ...
    showInfoAtivity(poiName, activityName) {
      ...
      Array.prototype.forEach.call(store.state.POIpivot, (poi) => {
        ...
        if (
          ...
          //il component per la visualizzazione delle visite usa mediaImages
          selectedPOI.mediaImages = selectedPOI.media;
        }
      });
      ...
      if (activityName !== "Visita del luogo") {
        ...
        this.activityVisitPOISelectedForInfo = selectedPOI;
          // "La visita del " +
          // poiName +
      ...
      Array.prototype.forEach.call(this.itinerario.poi, (poi) => {
        ...
        if (isStartingPoint) {
          this.markers.push({
            ...
            image: poi["media"]
              ? poi["media"][0]["o:thumbnail_urls"]["large"]
              : undefined,
