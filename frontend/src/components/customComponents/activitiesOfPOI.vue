  ...
  <div class="mt-3">
    <div class="row">
      ...
      <div class="col-1 text-right">
        ...
        <ul id="difficultiesLevelIcons" class="ulDiffIcons">
          <li
            v-for="(it['geo:ha_difficolta'][0], index) in it['geo:ha_difficolta']"
            :key="'geo:ha_difficolta' + index"
            class="difficultiesLevelsIcons"
          >
            <div v-if="index === 0">
              <svg
                v-if="it['geo:ha_difficolta'][0]['display_title'] === 'Scuola dell\'Infanzia'"
              ...
              <svg
                v-else-if="it['geo:ha_difficolta'][0]['display_title'] === 'Scuola Primaria'"
                xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink"
                width="30px"
                height="29px"
              ...
              <svg
                v-else-if="
                  it['geo:ha_difficolta'][0]['display_title'] ===
                ...
                version="1.1"
              >
                <g id="scuolaSecondariaDiPrimoGrado">
                  <path
                    style="
                                                        fill-rule: nonzero;
                                                        fill: #FFFFFF
              ...
              <svg
                ...
                version="1.1"
              >
                <g id="scuolaSecondariaDiSecondoGrado">
                  <path
                    style="
                                                        fill-rule: nonzero;
                                                        fill: #FFFFFF
              ...
              <svg
                v-else-if="it['geo:ha_difficolta'][0]['display_title'] === 'Università'"
                xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink"
                width="30px"
                height="29px"
              ...
              <svg
                v-else-if="it['geo:ha_difficolta'][0]['display_title'] === 'Per Tutti'"
                xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink"
                width="23px"
                height="50px"
    ...
    <div class="row text-left">
      <div class="col-12 font-italic">Livello di difficoltà: 
...
<svg
    ...
    <div class="row text-left">
      <div class="col-12">
        <collapse>
          <collapse-item title="Più dettagli">
            <div
              style="text-align: justify; text-justify: inter-word"
              class="font-weight-normal pb-0"
            >
