                          ...
                          >
                                      ...
                                      <div class="row">
                                        ...
                                        <!--<div class="col-1">
                                          <span
                                            ...
                                            @click="
                                              expandText(
                                                'descriptionPOI' + index,
                                                'expandTextIcon' + index,
                                                'collapseTextIcon' + index
                                              )
                                            "
                            ...
                            <!--<collapse v-if="item.poiVisibleWithFilters">
                              ...
                              <collapse-item
                                ...
                                style="color: black"
                              >
                                <div v-if="item['mis'].length > 0" class="">
                                  <div v-if="item.poiVisibleWithFilters">
                                    <div
                                      v-for="(it, ind) in item.mis"
                                      :key="
